...
static const TVBrand TV_BRANDS[] = {
    ...
    // ── Changhong (长虹) — NEC, addr 0x40 (POWER=0x12 confirmed by user) ──
    // Vol codes from most common Changhong remote profile (Flipper-IRDB alt codeset).
    // 0x47/0x46 caused TV beep (valid NEC frame) but no volume change — wrong command.
    {"changhong",   NEC,  0x40,
        0x12, 0x1A, 0x1E, 0x19, 0x1D, 0x13, 0x14,  // power,vol+,vol-,ch+,ch-,mute,input
